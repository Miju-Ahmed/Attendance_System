"""
Entry/Exit Attendance System v5 - Production Ready
====================================================
Pipeline per frame:
...
4) Line crossing detection with state machine
5) Database recording for entry/exit events

Features:
- Processes every frame for maximum accuracy
- Fixed line state initialization bug (never uses side=0)
- Comprehensive logging for debugging
- State machine prevents duplicate recordings
- 30-frame cooldown between events
